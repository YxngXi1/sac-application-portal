...
import { Calendar, Clock, Users, CheckCircle, XCircle, User, Edit, ArrowLeft } from 'lucide-react';
...
const PositionApplications: React.FC<PositionApplicationsProps> = ({ position }) => {
  ...
  // If viewing an application, show the ApplicationGrader
      ...
      <div className="bg-white border-b shadow-sm px-8 py-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-600">
            Manage applications for {position} position
          </p>
        </div>
      </div>
